...
import com.android.systemui.LegionSystemUIUtils;
...
public class NotificationPanelViewController extends PanelViewController {
    ...
    public NotificationPanelViewController(NotificationPanelView view,
        ...
        mDoubleTapGesture = new GestureDetector(mView.getContext(), new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onDoubleTap(MotionEvent e) {
                LegionUtils.switchScreenOff(mView.getContext());
    ...
    public void reTickerView(boolean visibility) {
        if (!LegionSystemUIUtils.settingStatusBoolean("reticker_status", mView.getContext())) return;
        ...
        if (visibility && getExpandedFraction() != 1) {
            ...
            if (LegionSystemUIUtils.settingStatusBoolean("reticker_colored", mView.getContext())) {
                int col;
    ...
    private void reTickerViewVisibility() {
        if (!LegionSystemUIUtils.settingStatusBoolean("reticker_status", mView.getContext())) {
            reTickerDismissal();
            return;
        }
